...
namespace LMS4xxx {
    ...
    public:
        ...
        // Build "sRN <name>" to read back a variable (write verification).
        [[nodiscard]] static std::vector<std::uint8_t> BuildReadVariable(std::string_view name);
        ...
        [[nodiscard]] static std::vector<std::uint8_t> BuildSetDatetime(std::uint16_t year, std::uint8_t month,
                                                                        std::uint8_t day,
