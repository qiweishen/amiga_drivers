...
namespace LMS4xxx {
    ...
    std::vector<std::uint8_t> CommandBuilder::BuildReadVariable(std::string_view name) {
        // sRN <name> (no parameters)
    ...
    std::vector<std::uint8_t> CommandBuilder::BuildCubicAreaFilter(bool enable, std::uint32_t min_dist,
