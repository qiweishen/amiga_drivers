...
static constexpr uint16_t GNSS_SOLUTION_PACKET_MESSAGE_ID = 0x0a02;
static constexpr size_t GNSS_SOLUTION_PACKET_LENGTH = 77;
static constexpr uint16_t INS_SOLUTION_PACKET_MESSAGE_ID = 0x0a03;
...
static constexpr uint16_t RAW_IMU_DATA_MESSAGE_ID = 0x0a01;
static constexpr size_t RAW_IMU_DATA_LENGTH = 30;
static constexpr uint16_t RTCM_ROVER_DATA_MESSAGE_ID = 0x0a06;
static constexpr size_t RTCM_ROVER_DATA_LENGTH_MAX = 1024;
static constexpr uint8_t NEMA_ASCII_START = '$';

static constexpr uint16_t RTCM_BASE_DATA_MESSAGE_ID = 0x0b02;
static constexpr uint16_t REQUEST_INFO_COMMAND = 0xcc01;
